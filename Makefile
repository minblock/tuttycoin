...
pkgdatadir = $(datadir)/tuttycoin
pkgincludedir = $(includedir)/tuttycoin
pkglibdir = $(libdir)/tuttycoin
pkglibexecdir = $(libexecdir)/tuttycoin
...
ACLOCAL = ${SHELL} /tuttycoin/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
AUTOCONF = ${SHELL} /tuttycoin/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /tuttycoin/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /tuttycoin/build-aux/missing automake-1.15
AVX2_CXXFLAGS = -mavx -mavx2
AWK = mawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = tuttycoin-cli
BITCOIN_DAEMON_NAME = tuttycoind
BITCOIN_GUI_NAME = tuttycoin-qt
BITCOIN_TX_NAME = tuttycoin-tx
BITCOIN_WALLET_TOOL_NAME = tuttycoin-wallet
...
COPYRIGHT_HOLDERS_FINAL = The Tuttycoin Core developers
COPYRIGHT_HOLDERS_SUBSTITUTION = Tuttycoin Core
COPYRIGHT_YEAR = 2019
CPP = gcc -E
...
MAINT = 
MAKEINFO = ${SHELL} /tuttycoin/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = tuttycoin
PACKAGE_BUGREPORT = https://github.com/tuttycoin-project/tuttycoin/issues
PACKAGE_NAME = Tuttycoin Core
PACKAGE_STRING = Tuttycoin Core 0.18.1
PACKAGE_TARNAME = tuttycoin
PACKAGE_URL = https://tuttycoin.org/
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /tuttycoin
abs_srcdir = /tuttycoin
abs_top_builddir = /tuttycoin
abs_top_srcdir = /tuttycoin
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /tuttycoin/build-aux/install-sh
...
OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  ...
  $(OSX_APP)/Contents/MacOS/Tuttycoin-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
$(OSX_APP)/Contents/MacOS/Tuttycoin-Qt: all-recursive
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Tuttycoin-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Tuttycoin-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
