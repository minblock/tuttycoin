# Support for Output Descriptors in Tuttycoin Core

Since Tuttycoin Core v0.17, there is support for Output Descriptors. This is a
...
on Tuttycoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Tuttycoin Core wallets, a convenience function `combo` is
