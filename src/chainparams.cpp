...
{
    const char* pszTimestamp = "4/20/2020 Provigen Networks: Now accepting Incotoshies!";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1585982641, 889144, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xf3b5e8866d49a731e7599a7663dc71a9de2bb59776f334ddaf4eacdbfffcc8cb"));
        assert(genesis.hashMerkleRoot == uint256S("0xd5dfa4533ca148a9bf544944442e1a03479027cc48d0e3cd5b626697397c1ec8"));
        ...
        vSeeds.emplace_back("seed-a.tuttycoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.tuttycointools.com");
        vSeeds.emplace_back("dnsseed.tuttycoinpool.org");
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1486949366, 949193, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x47b588a67ad5dc2f6603f1baf6fb0732565d64d39f11b5088b4618d95b91826d"));
        assert(genesis.hashMerkleRoot == uint256S("0xd5dfa4533ca148a9bf544944442e1a03479027cc48d0e3cd5b626697397c1ec8"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.emplace_back("testnet-seed.tuttycointools.com");
        vSeeds.emplace_back("seed-b.tuttycoin.loshan.co.uk");
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x05c588837a8126578a071fb62c1ff9cd90123aa4365ea17f3c3a0ace26d97f19"));
        assert(genesis.hashMerkleRoot == uint256S("0xd5dfa4533ca148a9bf544944442e1a03479027cc48d0e3cd5b626697397c1ec8"));
