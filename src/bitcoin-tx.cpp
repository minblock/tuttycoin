...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " tuttycoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  tuttycoin-tx [options] <hex-tx> [commands]  Update hex-encoded tuttycoin transaction\n" +
            "or:     tuttycoin-tx [options] -create [commands]   Create hex-encoded tuttycoin transaction\n" +
            "\n";
