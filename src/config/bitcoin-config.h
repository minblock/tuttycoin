...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Tuttycoin Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Tuttycoin Core"
...
#define PACKAGE_BUGREPORT "https://github.com/tuttycoin-project/tuttycoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Tuttycoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Tuttycoin Core 0.18.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "tuttycoin"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://tuttycoin.org/"
