...
"""Verify that starting tuttycoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start tuttycoin with -h for help text")
        ...
        self.log.info("Start tuttycoin with -version for version information")
        ...
        self.log.info("Start tuttycoind with -fakearg to make sure it does not start")
